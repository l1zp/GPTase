...
This agent uses the EnzymeKineticsExtractorTool to extract structured
enzyme reaction data from scientific literature text and tables.
"""
...
class EnzymeKineticsExtractorAgent(BaseAgent):
    ...
    This agent delegates to EnzymeKineticsExtractorTool to extract:
