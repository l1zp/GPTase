...
class TrackingMixin:
    ...
    Example:
        ...
        class MyTool(BaseTool, TrackingMixin):
            def __init__(self, model_manager, agent_id=None, agent_name=None,
                        session_id=None, step_id=None):
                BaseTool.__init__(self, name="my_tool", description="...")
                TrackingMixin.__init__(self, agent_id, agent_name, session_id, step_id)
    ...
    def update_tracking(
        ...
        Args:
            ...
            agent_name: New agent name (None to keep current).
