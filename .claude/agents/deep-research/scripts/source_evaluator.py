...
class SourceEvaluator:
    ...
    def evaluate_source(self,
                        ...
                        author: Optional[str] = None) -> CredibilityScore:
        ...
        overall = (domain_score * 0.35 + recency_score * 0.20 + expertise_score * 0.25
                   + bias_score * 0.20)

        # Determine factors
        factors = self._identify_factors(domain, domain_score, recency_score,
                                         expertise_score, bias_score)

        # Generate recommendation
        recommendation = self._generate_recommendation(overall)

        return CredibilityScore(overall_score=round(overall, 2),
    ...
    def _evaluate_expertise(self, domain: str, title: str,
                            author: Optional[str]) -> float:
    ...
    def _identify_factors(self, domain: str, domain_score: float, recency_score: float,
                          expertise_score: float, bias_score: float) -> Dict[str, str]:
