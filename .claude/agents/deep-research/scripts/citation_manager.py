...
class CitationManager:
    ...
    def export_to_file(self, filepath: str, style: str = "markdown"):
        """Export bibliography to file with retry logic"""
    ...
    def import_from_file(self, filepath: str):
        """Import bibliography from file with retry logic"""
...
if __name__ == '__main__':
    ...
    # Add sources
    id1 = manager.add_source(url="https://example.com/article1",
                             title="Understanding Deep Research",
                             authors=["Smith, J.", "Johnson, K."],
                             publication_date="2025")

    id2 = manager.add_source(url="https://example.com/article2",
