...
def read_file_with_retry(filepath: Path) -> str:
...
def write_file_with_retry(filepath: Path, content: str):
...
def main():
    ...
    # Use retry-enabled file reading
    markdown_text = read_file_with_retry(md_file)
