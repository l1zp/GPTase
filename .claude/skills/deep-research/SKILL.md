...
name: deep-research
description: |
  ESSENTIAL for comprehensive research requiring multiple sources, citation tracking, and verification. CONSULT THIS SKILL whenever the user asks for analysis, comparison, state-of-the-art reviews, or multi-perspective investigation - even if they don't explicitly say "research".
...
|---------------|------------------|
| Phase-by-phase instructions | [methodology.md](./reference/methodology.md) |
| Auto-continuation (unlimited length) | [continuation.md](./reference/continuation.md) |
| HTML/PDF generation | [html_generation.md](./reference/html_generation.md) |
| Report template | [report_template.md](./templates/report_template.md) |
| McKinsey HTML template | [mckinsey_report_template.html](./templates/mckinsey_report_template.html) |

**Load on-demand:** Only read the reference file you need for the current phase. Do not preload all content.
...
> **Full details:** [continuation.md](./reference/continuation.md) - Complete auto-continuation protocol with state management, agent handoff, and quality gates.
...
> **Full details:** [html_generation.md](./reference/html_generation.md) - Complete HTML/PDF generation workflow with McKinsey template, citation tooltips, and verification.
...
- [Auto-Continuation Protocol](./reference/continuation.md) - Unlimited length reports
- [HTML/PDF Generation](./reference/html_generation.md) - McKinsey-style reports
- [Report Template](./templates/report_template.md) - Output structure
- [McKinsey HTML Template](./templates/mckinsey_report_template.html) - Professional HTML
