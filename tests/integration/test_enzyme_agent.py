...
async def test_enzyme_agent_text():
    ...
    api_key = os.getenv("API_KEY") or os.getenv("OPENAI_API_KEY") or os.getenv("GPTASE_OPENAI_API_KEY")
    ...
    pytest.skip("Integration test requires proper document setup - use examples/reaction_extractor.py instead")
