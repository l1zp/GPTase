...
def test_thinking_config():
    ...
    assert params2["extra_body"]["enable_thinking"] == True, "extra_body should have enable_thinking=True"
    ...
    config3 = ModelConfig(
        ...
        base_url="https://test.com",
        enable_thinking=True,
        provider_config={"stream": True, "custom_param": "value"}
    )
    ...
    assert params3["extra_body"]["enable_thinking"] == True, "extra_body should be preserved"
    assert params3["stream"] == True, "provider_config should be merged"
    assert params3["custom_param"] == "value", "custom provider_config should be preserved"
